...
import 'package:bip32_custom/src/utils/ecurve.dart' show isPoint;
...
class P2SHData {
  ...
  @override
  String toString() {
    return 'P2SHData{address: $address, hash: $hash, output: $output, signature: $signature, pubkey: $pubkey, input: $input}';
  }
}
